...
(function() {
    ...
    $("div.active").next("div.timeline-item").css("border-left-width", "0");
...
// (function() {
// 	$(".baggage-main-content").slideUp();
// 	  $(document).on('click','#baggage-btn',function(e) {
// 			// alert("CLICKED!");
// 			$('.baggage-main-content').toggleClass('show-content');
// 			$(this).parent().parent().parent().parent().find('.baggage-main-content').slideToggle();
...
// $('.baggage-detail-wrap').slideUp();
//  $(document).on('click', '.baggage-detail', function (e) {
// 	$(this).toggleClass('show');
// 	// $(this).parent().parent().parent().parent().find('.baggage-detail-wrap').slideToggle();
// 	$(this).parent().parent().parent().parent().find('.baggage-detail-wrap').slideToggle();
// });
...
$(document).ready(function() {
    ...
    // $('.baggage-detail-wrap').hide(); 
    $(document).on('click', '.baggage-detail', function (e) {
        e.preventDefault();
        var $currentDetailWrap = $(this).closest('.booking-list-item').find('.baggage-detail-wrap');
        $('.baggage-detail-wrap').not($currentDetailWrap).slideUp();
        $currentDetailWrap.slideToggle();
        $('.baggage-detail').not(this).removeClass('show');
        $(this).toggleClass('show');
    });
});
