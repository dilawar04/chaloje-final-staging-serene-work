...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'coupons.' . $this->id_key])->merge(request()->query())->toArray();
...
, coupons.discount
-- , coupons.total_amount
, coupons.start_date
, coupons.end_date
-- , coupons.free_shipping
, coupons.usage_policy
, coupons.usage_limit
, coupons.no_used
, coupons.status
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('user_types', 'user_types.id', '=', 'coupons.customer_type');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method coupons store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        $validator_rules = [
            ...
            'coupon_code' => "required|unique:{$this->table},coupon_code,{$id},{$this->id_key}",
