...
class MarkupController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method Markup index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'markups.' . $this->id_key])->merge(request()->query())->toArray();
...
, markups.created_at
    ...
    /**
     * *****************************************************************************************************************
     * @method markups store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        $validator = Validator::make(\request()->all(), [
            'airline' => 'required|unique:markups,airline,'.$markup->id,
        ]);
        ...
        /** -------- Upload Files */
        $files = upload_files(['file'], "assets/front/{$this->table}/");
        if (count($files) > 0) {
