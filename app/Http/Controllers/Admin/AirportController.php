...
class AirportController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method airports index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'airports.' . $this->id_key])->merge(request()->query())->toArray();
...
, airports.created_at
    ...
    /**
     * *****************************************************************************************************************
     * @method airports store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Validation */
        $validator_rules = [
            'IATA_code' => "required|unique:{$this->table},IATA_code,{$id},{$this->id_key}",
            'airport' => "required",
        ];
