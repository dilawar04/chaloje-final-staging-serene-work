...
";
        ...
        if (request()->ajax()) {
            ...
            return view('admin.agents.grid', compact('paginate_OBJ', 'query'));
        }
    }
    ...
    public function form()
    {
        ...
        /** -------- Response */
        \View::share('_this', (object)get_object_vars($this));
        return view('admin.agents.form', compact('row'));
    }
    ...
    public function store()
    {
        ...
        $validator_rules = [
            ...
            'username' => "required|unique:{$this->table},username,{$id},{$this->id_key}",
    ...
    public function view()
    {
        ...
        if (request()->ajax()) {
            ...
            return view('admin.agents.view', compact('row', 'config'));
        } else {
