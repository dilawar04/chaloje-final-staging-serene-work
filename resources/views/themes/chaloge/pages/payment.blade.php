...
<div class="col-md-6">
    ...
    <h3>{{ $flight->ORGN }} <i class="fa fa-arrow-right"></i> {{ $flight->DEST }}</h3><sup>({{ $flight->baggage->title }})</sup>

    <div class="p-0 border-top-blue"><span class="flight_no">{{ $flight->AIRLINE }} [Flight No: {{ $flight->FLIGHT_NO }}]</span>
        <div class="main_section_flight" style="margin-top: 20px;
        margin-left: -50px;">
...
<span style="border: solid 1px lightgrey; margin-right: 10px"></span>
<div class="col-md-6 sec-main">
    ...
    <div class="sec" >
        <h3>Total Charges: </h3>
        <h3> PKR  {{ number_format($booking->total_amount) }}</h3>
    </div>
</div>
</div>
</div>
    ...
    <div class="row mb-5 justify-content-center">
        <div class="col-md-10">
            <form method="post" class=" payment-hbl">
                <input type="hidden" name="order_number" value="{{ $booking->id }}">
