                    ...
                    <div class="account-sign-in">
                        ...
                        <form action="{{ url("customer/login") }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" name="email" placeholder="Enter email">
                                <small id="emailHelp" class="form-text text-muted">We'll never share your Email and Name with
                                    anyone else.</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="button-bottom">
                                <button type="submit" class="w-100 btn btn-solid" style="text-align: center; display: flex; justify-content: center;">SignUp</button>
                            </div>
                                <div class="divider text-center">
                                    <h6>OR</h6>
                                </div>
                                <a href="{{ url('/login') }}" >
                                    <button type="submit" class="w-100 btn btn-solid btn-outline text-center" style="margin-bottom: 40px;text-align: center; display: flex; justify-content: center;">Have An Account</button>
                                </a>
                            </div>
                        </form>
                    </div>
