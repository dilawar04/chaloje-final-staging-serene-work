@php
            $status_column_data = DB_enumValues('amenities_groups', 'status');
...
<form action="{{ admin_url('', true) }}" method="get" enctype="multipart/form-data" id="amenities_groups-form">
    @csrf
    @include('admin.layouts.inc.stickybar', compact('form_buttons'))
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_amenities_groups">
                    ...
                    <div class="kt-portlet__body kt-padding-0">
                        ...
                        $grid->dt_column(['created' => ['input_options' => ['class' => 'm_datepicker']]]);
                                                $grid->dt_column(['icon' => ['align' => 'center',
                            'wrap' => function($value, $field, $_row) use($_this) {
