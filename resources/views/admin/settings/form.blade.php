                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="nav flex-column nav-pills mb-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <a class="nav-link" id="airline-api-tab" data-toggle="pill" href="#airline-api" aria-controls="airline-api"><i class="flaticon2-analytics"></i> API Setting</a>
                                ...
                                <div class="col-lg-10">
                                    <div class="tab-content mb-5 mr-5" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="airline-api">@include('admin.settings.airline-api')</div>
