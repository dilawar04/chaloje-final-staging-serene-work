@php
    $status_column_data = \App\Order::groupBy('status')->pluck('status');
    if(count($status_column_data) == 0){
        $status_column_data = [];
    }
...
<form action="{{ admin_url('', true) }}" method="get" enctype="multipart/form-data" id="orders-form">
    @csrf
    @include('admin.layouts.inc.stickybar', compact('form_buttons'))
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_orders">
